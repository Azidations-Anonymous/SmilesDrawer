...
| `src/drawing/SvgWrapper.ts:604-634`<br>`src/drawing/draw/CanvasPrimitiveDrawer.ts:174-182` | Point radius `≈6.7px`, stroke width `1.5` | Terminal “dot” atoms use constant radii/stroke widths. | `rendering.atoms.pointRadius` and `rendering.atoms.pointMaskRadius`. |
